...
export default function Register() {
  ...
  const handleSubmit = async () => {
    // Validate name without spaces and length greater than 4
    if (form.name.trim().indexOf(" ") !== -1 || form.name.trim().length <= 4) {
      toast.error("Name should not contain spaces and must be greater than 4 characters.");
      return;
    }
      ...
      <div className="container">
        ...
        <div className="row justify-content-md-center mt-4">
          <div className="col-lg-5 card border-primary mb-3">
            <div className="card-holder h4 text-center">Register an Account</div>
            <div className="card-body">
              <div className="form-group">
                <label className="col-form-label mt4">Name</label>
                <input
                  type="text"
                  name="name"
              ...
              <div className="form-group">
                <label className="col-form-label mt4">Username</label>
                <input
                  type="text"
                  name="username"
                  onChange={handleInputChnage}
              ...
              <div className="form-group">
                <label className="col-form-label mt4">Email</label>
                <input
                  type="text"
                  name="email"
                  onChange={handleInputChnage}
              ...
              <div className="form-group">
                <label className="col-form-label mt4">Password</label>
                <input
                  type="text"
                  name="password"
                  onChange={handleInputChnage}
